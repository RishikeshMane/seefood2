...
st.set_page_config(page_icon="", page_title="Project 2")
...
st.markdown("<h1 style='text-align: center; color: orange;'>Food Recognition app with top 5 priditions</h1>", unsafe_allow_html=True)
